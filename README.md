...
| slidesToScroll             | `React.PropTypes.oneOfType([ React.PropTypes.number, React.PropTypes.oneOf(['auto'])])` | Slides to scroll at once. Set to `"auto"` to dynamically scroll based on user swipe length. Is overridden to `slidesToShow` when `transitionMode="fade"`                                                                                                                               |                                                                           |
